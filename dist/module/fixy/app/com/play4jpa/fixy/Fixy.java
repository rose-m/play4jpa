...
public interface Fixy {
     ...
     *
     * @param files
     *         list of fixture files using full qualified path names, e.g. com/example/fixtures/myfixture.yaml.
     */
     ...
     *
     * @param postProcessor
     *         a processor that is called before entities will be persisted
     * @param <T>
     *         the entity type on which the processor operates
     */
